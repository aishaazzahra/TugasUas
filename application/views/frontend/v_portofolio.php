        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="<?= base_url() ."#features" ?>">Features</a></li>
              <li class="scroll-to-section"><a href="<?= base_url() ."frontend/about" ?>">About Us</a></li>
              <li class="scroll-to-section"><a href="<?= base_url() ."frontend/service" ?>">Services</a></li>
              <li class="scroll-to-section"><a href="<?= base_url() ."frontend/portofolio" ?>">Portfolio</a></li>
              <li class="scroll-to-section"><a href="<?= base_url() ."frontend/contact" ?>">Contact Us</a></li> 
