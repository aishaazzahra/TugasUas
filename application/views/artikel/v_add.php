            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="link1" name="link1" value=" <?= set_value('link1'); ?>">
                    ...
                    <div class="form-group row">
                        <label for="Email" class="col-sm-2 col-form-label">Artikel</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="artikel1" name="artikel1" value="<?= set_value('artikel1'); ?>">
                            <small class="text-danger">
                                <?php echo form_error('artikel1') ?>
                            </small>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="gambar1" name="gambar1" value="<?= set_value('gambar1'); ?>">
                            <small class="text-danger">
