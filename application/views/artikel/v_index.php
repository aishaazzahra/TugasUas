...
<div class="container pt-5">
    ...
    <div class="row">
        <div class="col-md-12">
            <a class="btn btn-primary mb-2" href="<?= base_url('backend/add'); ?>">Tambah Data</a>
            <div mb-2>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="tableMahasiswa">
                            ...
                            <tbody>
                                <?php foreach ($user as $row) : ?>
                                    <tr>
                                        <td>
                                            <a href="<?= site_url('backend/edit/' . $row->id) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> </a>
    ...
    $('#tableMahasiswa').on('click', '.item-delete', function() {
        ...
        $('#btdelete').unbind().click(function() {
            $.ajax({
                ...
                method: 'get',
                async: false,
                url: '<?php echo base_url() ?>backend/delete/',
                data: {
                    id: id
                },
                dataType: 'json',
