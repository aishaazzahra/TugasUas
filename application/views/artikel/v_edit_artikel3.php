            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="artikel3" name="artikel3" value="<?= $artikel->artikel3; ?>">
                            <small class="text-danger">
                                <?php echo form_error('artikel3') ?>
                            </small>
                        </div>
                    </div>
                    <div class="form-group row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="hidden" class="form-control" id="Id" name="id" value=" <?= $artikel2->id; ?>">
                            <input type="text" class="form-control" id="link3" name="link3" value=" <?= $artikel2->link3; ?>">
                            <small class="text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="artikel3" name="artikel3" value="<?= $artikel2->artikel3; ?>">
                            <small class="text-danger">
                                <?php echo form_error('artikel3') ?>
                            </small>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="gambar3" name="gambar3" value="<?= $artikel2->gambar3; ?>">
                            <small class="text-danger">
