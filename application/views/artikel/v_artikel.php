...
<div class="container pt-5">
    ...
    <div class="row">
        <div class="col-md-12">
            <a class="btn btn-primary mb-2" href="<?= base_url('backend/tambah'); ?>">Tambah Data</a>
            <div mb-2>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="tableMahasiswa">
                            ...
                            <tbody>
                                <?php foreach ($artikel as $row) : ?>
                                    <tr>
                                        <td>
                                            <a href="<?= site_url('backend/ubah/' . $row->id) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> </a>
                            ...
                            <tr class="table-success">
                                ...
                                <?php foreach ($artikel as $row) : ?>
                                    <tr>
                                        <td>
                                            <a href="<?= site_url('backend/edit_artikel2/' . $row->id) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> </a>
                                            <a href="javascript:void(0);" data="<?= $row->id ?>" class="btn btn-danger btn-sm item-delete"><i class="fa fa-trash"></i> </a>
                                        </td>
                                        <td><?= $row->link2?></td>
                                        <td><?= $row->artikel2 ?></td>
                            ...
                            <tr class="table-success">
                                ...
                                <?php foreach ($artikel as $row) : ?>
                                    <tr>
                                        <td>
                                            <a href="<?= site_url('backend/edit_artikel3/' . $row->id) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> </a>
                                            <a href="javascript:void(0);" data="<?= $row->id ?>" class="btn btn-danger btn-sm item-delete"><i class="fa fa-trash"></i> </a>
                                        </td>
                                        <td><?= $row->link3?></td>
                                        <td><?= $row->artikel3 ?></td>
                            ...
                            <tr class="table-success">
                                ...
                                <?php foreach ($artikel as $row) : ?>
                                    <tr>
                                        <td>
                                            <a href="<?= site_url('backend/edit_artikel4/' . $row->id) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> </a>
                                            <a href="javascript:void(0);" data="<?= $row->id ?>" class="btn btn-danger btn-sm item-delete"><i class="fa fa-trash"></i> </a>
                                        </td>
                                        <td><?= $row->link4?></td>
                                        <td><?= $row->artikel4 ?></td>
    ...
    $('#tableMahasiswa').on('click', '.item-delete', function() {
        ...
        $('#btdelete').unbind().click(function() {
            $.ajax({
                ...
                method: 'get',
                async: false,
                url: '<?php echo base_url() ?>backend/delete_artikel/',
                data: {
                    id: id
                },
                dataType: 'json',
